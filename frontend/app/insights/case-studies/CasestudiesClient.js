...
export default function CaseStudyPage() {
  ...
  const fetchBanners = async () => {
    const res = await axios.get(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/casestudiesbanner/active`,
    );
    setBanners(res.data);
  };
        ...
        <section className="py-20 bg-slate-50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-slate-600 mb-6">
              The sponsor faced delays in study startup due to fragmented
              systems, manual CRF design, and slow regulatory coordination.
              Traditional workflows created bottlenecks across data management
              and site activation.
            </p>
