...
export const metadata = {
  title: "Privacy Policy | eRIC SOLUTIONS",
  description: "Read the eRIC SOLUTIONS Privacy Policy to learn how we collect, use, protect, and manage your personal information and data securely.",
  alternates: {
    canonical: "https://www.ericsolutions.com/privacy-policy",
  },
};
...
const PrivacyPolicy = () => {
  return (
    <>
    <div className="bg-[#FEF0E1] min-h-screen py-10 px-4 mt-38">
