                  ...
                  <tr key={article._id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="p-4 text-center">
                      <div className="flex justify-center gap-3">
                        <button
                          onClick={() =>
                            router.push(`/viewer/article/${article._id}`)
                          }
                          className="cursor-pointer flex items-center gap-2 px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-md text-sm"
                        >
                          {/* <FaEdit size={12} /> */}
                          View
                        </button>
