  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        router.push('/viewer/timeline/list');
      }
    } catch {
 ...
 return (
  <div className=" bg-gray-50 flex items-center justify-center p-6">
    <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
      <Link href="/viewer/timeline/list">
      <button
            type="submit"
            className="bg-blue-600 text-white px-4 py-1 rounded-xl font-medium hover:bg-blue-700 transition shadow-md hover:shadow-lg mb-3 cursor-pointer"
          >
            Back
          </button>
